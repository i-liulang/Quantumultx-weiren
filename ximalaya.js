...
^http[s]?:\/\/.+ximalaya.+(product/info|/mobile-user/v2/homePage|/vip/v1/recommand/ts|mobile-playpage/playpage/tabs|/mobile-album/album/page/ts|mobile/v1/album/track/ts).*$ url script-response-body ximalaya.js
...
if (url.indexOf(p2) != -1) {
    ...
    obj.data.userInfo.userLevelIcon = "http://audio.ali.xmcdn.com/group83/M00/AD/3D/wKg5I182B77S36SrAAADek0PZ8k23.webp";
    delete obj.data.recommendVipProduct;
    delete obj.data.moreVipChannels;
    delete obj.data.jointVipProducts;
    //delete obj.data.recommendVipProduct.purchasePopUpsText;
...
//播放页面剩余时间
if (url.indexOf(p3) != -1) {
    delete obj.data.playpage.promotionGuideInfo.countdownText;
    delete obj.data.playpage.promotionGuideInfo.expireTime;
obj.data.playpage.promotionGuideInfo.buttonText = "联系作者";
obj.data.playpage.promotionGuideInfo.guidance = "点击联系作者即可添加作者qq";
obj.data.playpage.promotionGuideInfo.explainText = "作者伟人qq55749353";
obj.data.playpage.promotionGuideInfo.buttonActionUrl = "http://n8t.cn/isRcT";
